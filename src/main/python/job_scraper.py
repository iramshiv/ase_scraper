...
def job_scraper(url):
    ...
    time_div = bs.find_all('li', {'class': 'styled__JobMetadataElement-sc-7an0zf-3 cyslgT'})

    for time_posted in time_div:
        for article_div in bs.find('div', {'class': 'styled__ResultsSectionContainer-gdhf14-0 bOhoEh'}):
